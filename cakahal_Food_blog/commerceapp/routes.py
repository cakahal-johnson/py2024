...
from commerceapp import app, db, bcrypt, mail
from commerceapp.forms import RegistrationForm, LoginForm, UpdateDashboardForm, FoodForm, TablesForm, PostForm
from commerceapp.models import User, Order, Tables, Post
...
def send_mail(users):
    msg = Message('Welcome', sender='allenwalker.associate@gmail.com', recipients=[users])
    msg.body = ''' welcome
    '''
    mail.send(msg)
