...
python has Four data types of data collections

LIST: is a collection which is ordered and changeable, Allows duplicates members
Tuple: is a collection which is ordered and unchangeable, Allows duplicate
SET: is a collection which is unordered and unindexed. No duplicate members
DICTIONARY: is a collection which is ordered and changeable. No duplicate memebers
============================================================
Ordered: means that the items have a defined order, and that order will not change, i.e if you add new item to a list, new items will be placed at the end of the list

Changeable: means that we can change, add and remove items in a list after it has been created.

Allow Duplicates: means since the list are indexed, lists can have items with the same vlaues

index: is just the positions first index is always 0(zero)

No Duplicate members: means cannot have two items with the same Key
