...
from flask import get_flashed_messages, render_template, url_for, redirect, flash, redirect, request, current_app
from commerceapp import app, db, bcrypt
from commerceapp.forms import RegistrationForm, LoginForm, DashboardForm, FoodForm, TablesForm
