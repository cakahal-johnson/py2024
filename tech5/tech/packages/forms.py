...
from wtforms import Form, IntegerField, SubmitField, DecimalField, StringField, BooleanField, TextAreaField, SelectField, validators
...
class Addpackages(Form):
    ...
    # image_2 = FileField('Image 2',
    #                     validators=[FileRequired(), FileAllowed(['jpg', 'png', 'gif', 'jpeg']), 'images only'])
    # image_3 = FileField('Image 3',
    #                     validators=[FileRequired(), FileAllowed(['jpg', 'png', 'gif', 'jpeg']), 'images only'])
