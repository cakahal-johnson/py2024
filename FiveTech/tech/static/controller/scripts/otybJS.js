...
function Msg(msg, color, dismiss, element, time) {
    if (dismiss == 1) {
        var show = "<div class='row1'><div class='col-lg-12'><div class='alert " + color + " alert-dismissable'><button type='button' style='width:auto; padding:1px; height: 30px;left:5%; margin:0px' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>" + msg + "</div></div></div>";
    } else if (dismiss == 0) {
...
function Msg2(msg, color, dismiss, element) {
    if (dismiss == 1) {
        var show = "<div class='row1'><div class='col-lg-12'><div class='alert " + color + " alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>" + msg + "</div></div></div>";
    } else if (dismiss == 0) {
        var show = "<div class='row1'><div class='col-lg-12'><div class='alert " + color + "'>" + msg + "</div></div></div>";
    }
    $(element).html(show);
